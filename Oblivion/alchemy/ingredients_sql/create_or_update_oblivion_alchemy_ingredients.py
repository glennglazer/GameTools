...
"""
File: create_or_update_oblivion_alchemy_ingredients.py
Author: Glenn Glazer

Create or incrementally update the oblivion_alchemy_ingredients table.
See create_or_update_morrowind_alchemy_ingredients.py for full design notes.
"""
...
TABLE_NAME = 'oblivion_alchemy_ingredients'
KEY_COL = 'name'
INDEX_NAME = 'o_i_name'
GAME_LABEL = 'Oblivion alchemy ingredients'

_SCRIPT_DIR = Path(__file__).parent.resolve()
_REPO_ROOT = _SCRIPT_DIR.parent.parent.parent
_JSON_DIR = _SCRIPT_DIR.parent / 'ingredients_json'
_DEFAULT_JSON_FILE = str(_JSON_DIR / 'oblivion_all_ingredients.json')
