...
"""
File: create_or_update_oblivion_alchemy_effects.py
Author: Glenn Glazer

Create or incrementally update the oblivion_alchemy_effects table.
...
TABLE_NAME = 'oblivion_alchemy_effects'
INDEX_NAME = 'o_e_name_effect'
