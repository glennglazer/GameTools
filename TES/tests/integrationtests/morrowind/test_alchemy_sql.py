"""Integration tests for Morrowind alchemy SQL loader scripts (create_or_update_*)."""
import json
import sqlite3
import subprocess
import sys
...
# ---------------------------------------------------------------------------
# apply_deletes (integration tests — real SQLite)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# apply_deletes_effects — NULL-safe (integration tests)
# ---------------------------------------------------------------------------
