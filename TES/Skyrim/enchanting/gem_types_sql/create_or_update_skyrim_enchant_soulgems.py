#!/usr/bin/python3
"""
Create or incrementally update the skyrim_enchant_soulgems table.

Table schema: skyrim_enchant_soulgems
  name           TEXT (unique key)
  weight         REAL
  value          INTEGER
  capacity       INTEGER
  trappable_souls TEXT
"""
...
TABLE_NAME = 'skyrim_enchant_soulgems'
KEY_COL = 'name'
INDEX_NAME = 's_esg_name'
GAME_LABEL = 'Skyrim enchanting soul gems'

_SCRIPT_DIR = Path(__file__).parent.resolve()
_REPO_ROOT = _SCRIPT_DIR.parent.parent.parent.parent
_JSON_DIR = _SCRIPT_DIR.parent / 'gem_types_json'
_DEFAULT_JSON_FILE = str(_JSON_DIR / 'skyrim_enchant_soulgems.json')
