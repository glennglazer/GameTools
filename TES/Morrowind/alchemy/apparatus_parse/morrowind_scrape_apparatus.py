"""Scrape Morrowind:Alchemy_Apparatus from UESP wiki → morrowind_apparatus_raw.json."""
import argparse
import json
import sys
...
_DEFAULT_OUT = str(_SCRIPT_DIR / "morrowind_apparatus_raw.json")
...
def main():
    ap = argparse.ArgumentParser(
        description="Scrape Morrowind alchemy apparatus page → raw JSON")
    ap.add_argument("out_file", nargs="?", default=_DEFAULT_OUT,
                    help="Output JSON file (default: morrowind_apparatus_raw.json)")
    args = ap.parse_args()
